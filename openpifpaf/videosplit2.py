...
def main():
    ...
    # data loader  
    _, _, _, \
    _, jaad_val_loader, _ = datasets.train_factory(args, [], [])
    ...
    for data, targets, meta in jaad_val_loader:
        ...
        #with show.image_canvas(im, 'im.png', show=args.show, fig_width=10.0, dpi_factor=1.0) as ax: skeleton_painter.keypoints(ax, keypoint_sets, scores=scores)
