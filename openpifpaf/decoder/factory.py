...
def factory_from_args(args, model, device=None):
    ...
    #print("seed ", args.seed_threshold) 0.2
...
def factory_decode(model, *, profile=None, **kwargs):
    ...
    headnames = tuple(h.shortname for h in model.head_nets if h.shortname != "crm")

    #print(headnames) # ('pif', 'paf')
    #print(Decoder.__subclasses__()) [<class 'openpifpaf.decoder.pif.Pif'>, <class 'openpifpaf.decoder.pifpaf.PifPaf'>, <class 'openpifpaf.decoder.pifspafs.PifsPafs'>]
    for decoder in Decoder.__subclasses__():
        ...
        #print("match ", decoder) #match  <class 'openpifpaf.decoder.pifpaf.PifPaf'>
